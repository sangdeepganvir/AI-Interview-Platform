...
function RecordAnswerSection({mockInterviewQuestions,activeQuestionIndex,interviewData}) {
    ...
    const UpdateUserAnswer = async() =>{
            ...
            setLoading(true);
            //Fetch feedback and correct answer from gemini
            ...
            "with rating feild and feedback field ";
  ...
  return (
    <div className='flex items-center justify-center flex-col'>
        <div className='flex flex-col mt-20 justify-center items-center bg-blue-700 rounded-lg p-5'>
